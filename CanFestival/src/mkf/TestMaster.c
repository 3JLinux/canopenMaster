...
UNS8 SDK_DATA_B0 = 0x1;		/* Mapped at index 0x2001, subindex 0x01 */
UNS8 SDK_DATA_B1 = 0x2;		/* Mapped at index 0x2001, subindex 0x02 */
UNS8 SDK_DATA_B2 = 0x3;		/* Mapped at index 0x2001, subindex 0x03 */
UNS8 SDK_DATA_B3 = 0x4;		/* Mapped at index 0x2001, subindex 0x04 */
UNS8 SDK_DATA_B4 = 0x5;		/* Mapped at index 0x2001, subindex 0x05 */
UNS8 SDK_DATA_B5 = 0x6;		/* Mapped at index 0x2001, subindex 0x06 */
UNS8 SDK_DATA_B6 = 0x7;		/* Mapped at index 0x2001, subindex 0x07 */
UNS8 SDK_DATA_B7 = 0x8;		/* Mapped at index 0x2001, subindex 0x08 */
UNS8 SDK_RCV_B0 = 0x1;		/* Mapped at index 0x2002, subindex 0x01 */
UNS8 SDK_RCV_B1 = 0x2;		/* Mapped at index 0x2002, subindex 0x02 */
UNS8 SDK_RCV_B2 = 0x3;		/* Mapped at index 0x2002, subindex 0x03 */
UNS8 SDK_RCV_B3 = 0x4;		/* Mapped at index 0x2002, subindex 0x04 */
UNS8 SDK_RCV_B4 = 0x5;		/* Mapped at index 0x2002, subindex 0x05 */
UNS8 SDK_RCV_B5 = 0x6;		/* Mapped at index 0x2002, subindex 0x06 */
UNS8 SDK_RCV_B6 = 0x7;		/* Mapped at index 0x2002, subindex 0x07 */
UNS8 SDK_RCV_B7 = 0x8;		/* Mapped at index 0x2002, subindex 0x08 */
...
/* index 0x1401 :   Receive PDO 2 Parameter. */
                    ...
                    UNS32 TestMaster_obj1401_COB_ID_used_by_PDO = 0x200;	/* 512 */
                    ...
                    subindex TestMaster_Index1601[] = 
                     {
                       ...
                       { RW, uint32, sizeof (UNS32), (void*)&TestMaster_obj1601[4] },
                       { RW, uint32, sizeof (UNS32), (void*)&TestMaster_obj1601[5] },
                       { RW, uint32, sizeof (UNS32), (void*)&TestMaster_obj1601[6] },
                       { RW, uint32, sizeof (UNS32), (void*)&TestMaster_obj1601[7] }
                     };

/* index 0x1800 :   Transmit PDO 1 Parameter. */
                    UNS8 TestMaster_highestSubIndex_obj1800 = 6; /* number of subindex - 1*/
                    UNS32 TestMaster_obj1800_COB_ID_used_by_PDO = 0x281;	/* 641 */
...
/* index 0x2001 :   Mapped variable SDK_DATA */
                    UNS8 TestMaster_highestSubIndex_obj2001 = 8; /* number of subindex - 1*/
                    subindex TestMaster_Index2001[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&TestMaster_highestSubIndex_obj2001 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B0 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B1 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B2 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B3 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B4 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B5 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B6 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_DATA_B7 }
                     };

/* index 0x2002 :   Mapped variable SDK_RCV */
                    UNS8 TestMaster_highestSubIndex_obj2002 = 8; /* number of subindex - 1*/
                    subindex TestMaster_Index2002[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&TestMaster_highestSubIndex_obj2002 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B0 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B1 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B2 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B3 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B4 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B5 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B6 },
                       { RW, uint8, sizeof (UNS8), (void*)&SDK_RCV_B7 }
                     };
...
const indextable * TestMaster_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x200F: i = 14;break;
		case 0x2010: i = 15;break;
		case 0x2011: i = 16;break;
		case 0x2012: i = 17;break;
		case 0x2013: i = 18;break;
		case 0x2014: i = 19;break;
		case 0x2015: i = 20;break;
		case 0x2016: i = 21;break;
		default:
