...
struct struct_s_transfer {
  UNS8           CliServNbr; /**< The index of the SDO client / server in our OD minus 0x1280 / 0x1200 */	// client 的索引

  UNS8           whoami;     /**< Takes the values SDO_CLIENT or SDO_SERVER */								// 客户端或服务器的值
  UNS8           state;      /**< state of the transmission : Takes the values SDO_... */					// 传输的状态
  UNS8           toggle;	
